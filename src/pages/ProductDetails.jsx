        ...
        <div className='bg-red-400 min-h-screen '>
            <div className='flex flex-col gap-6  max-w-6xl mx-auto px-6 py-10'>
                ...
                <div className="flex flex-col md:flex-row max-w-6xl mx-auto gap-10 items-start">
                    ...
                    <div className="md:w-1/2 flex flex-col gap-2 md:gap-5 justify-start">
                        <h3 className='md:text-4xl text-xl font-bold'>{product.name}</h3>
                        <p className='md:text-xl text-sm font-semibold text-purple-600 '>Monthly Rent:₹{product.price}/month</p>
                        <p className='md:text-xl  font-semibold' >Security Deposit: ₹{product.securityDeposit} (Refundable)</p>
                        <p className='md:text-xl  font-medium text-green-600 '>Available: {product.availability} ✅</p>
                    </div>
                </div>
